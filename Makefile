.PHONY: ankienv ankisync init serve docker_push deploy undeploy docker_run docker_push deploy_ollama undeploy_ollama docker_run_ollama health_local health_eks eksconfig
